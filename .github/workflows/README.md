...
**Note**: Integration tests are NOT run in CI/CD as they require a live API server.
...
Published to: https://www.npmjs.com/package/@sudobility/sports_api_client
...
SPORTS_API_ENDPOINT=http://localhost:8080 npm run test:integration
```
