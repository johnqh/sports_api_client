...
export interface ApiRugbyState {
  ...
  gameStatistics: Map<string, CachedData<RugbyGameStatistics[]>>;
  ...
  setGameStatistics: (key: string, data: RugbyGameStatistics[]) => void;
  ...
  getGameStatistics: (key: string) => RugbyGameStatistics[] | null;
